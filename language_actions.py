...
language_actions = {
    'en': {
        ...
        'select_object': 'select one of the following objects to find where it\'s placed'
    },
    'es': {
        ...
        'select_object':'Seleccione uno de los siguientes objetos para encontrar dónde está colocado'
    }
}
